...
For more information on how to do this, see our [authentication](/docs/getting-started/authentication) guide, which wires up the mechanisms to enable this to happen.
