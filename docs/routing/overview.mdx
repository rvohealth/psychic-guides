...
:::tip
See our detailed guides for more information

- [crud guide](/docs/routing/crud)
- [resourceful guide](/docs/routing/resources)
- [namespacing guide](/docs/routing/namespacing)
:::
