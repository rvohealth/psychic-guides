...
Dream and Psychic have been in development since early 2023 and in production use at [RVOHealth](https://www.rvohealth.com/) (our employer and sponsor of the entire Psychic ecosystem, which consists of [8 npm packages](https://www.npmjs.com/settings/rvoh/packages), these guides, and the demo application) since December 2023. Inspired by over a decade of Ruby on Rails experience, the framework has evolved into a full-featured, batteries-included solution refined through real-world production use.
