...
If you're using **Psychic 2.0** (Express-based), please see the [Psychic 2.0 documentation](/docs/psychic-v2/).
...
If you're using Psychic 2.0 with Express, see the [Psychic 2.0 documentation](/docs/psychic-v2/).
:::
