...
The `conf/inflections.ts` file enables the developer to adjust pluralization rules for certain words. This can be useful for handling irregular words, since otherwise generators and some of our lookup mechanisms will guess incorrectly at the pluralization or depluralization of a word.
