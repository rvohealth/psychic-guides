...
sidebar_position: 7
ai_summary: >-
  The conf/repl.ts file bootstraps the REPL (console). By default loads all
  models and services to global context (namespaced by file path). Supports
  adding custom globals to replServer.context and dynamic imports.
---
