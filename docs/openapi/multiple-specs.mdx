...
ai_summary: Multiple OpenAPI specs can be configured for different audiences (admin, mobile, web). Each spec has its own outputFilename. Supports suppressResponseEnums option for mobile clients. Update ApplicationController#openapiNames getter to include all spec names.
---
