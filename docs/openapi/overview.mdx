...
[OpenAPI](https://spec.openapis.org/oas/v3.0.2.html) is a standard for representing API specifications. It is useful whether your service will be consumed by other services or front end clients such as mobile devices. The OpenAPI spec also automatically generates front-end routes and types for your React, Vue, or Nuxt app in Psychic.
