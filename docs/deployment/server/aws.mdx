...
ai_summary: Deploy to AWS using Fargate. Single Dockerfile provisions web server, worker, and console instances. Different initialization commands for worker, console, or web. Requires ECR instances for each. Includes Dockerfile example and Fargate task definitions.
---
