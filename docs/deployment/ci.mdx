...
ai_summary: CI setup using GitHub Actions. Run build, eslint, unit specs, and feature specs as PR checks. Includes example GitHub Actions workflow with PostgreSQL and Redis services, unit tests, and feature tests.
---
