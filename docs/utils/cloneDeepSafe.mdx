---
sidebar_position: 3
ai_summary: "cloneDeepSafe returns a deep clone of a value, with special handling for Dream instances, Query instances, DateTime, CalendarDate, and other Dream types."
---
