---
sidebar_position: 5
ai_summary: "CalendarDate handles database date columns (year-month-day). Automatically converted when loading models. Provides date operations without timezone math. Never use JavaScript's Date class. Create via today(), fromISO(), fromObject(), fromDateTime(). Convert to DateTime, ISO string, or object."
---
