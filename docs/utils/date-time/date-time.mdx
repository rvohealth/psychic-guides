...
ai_summary: 'DateTime handles database timestamp columns with microsecond precision. Automatically converted when loading models. Always stored as UTC in database. Provides timezone manipulation, formatting, math operations, and comparisons. Import from @rvoh/dream (not Luxon).'
---
