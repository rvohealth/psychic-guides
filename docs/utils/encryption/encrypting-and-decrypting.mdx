---
sidebar_position: 2
ai_summary: Encrypt.encrypt() and Encrypt.decrypt() provide simple encryption/decryption. Must match algorithm and key for encryption and decryption. Recommended to abstract into helper functions. Supports key rotation with current/legacy keys.
---
