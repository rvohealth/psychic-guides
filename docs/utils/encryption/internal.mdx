...
ai_summary: Psychic and Dream use Encrypt class internally. Cookie encryption config in conf/app.ts. Encrypted decorator config in conf/dream.ts. Supports current/legacy keys for key rotation.
---
