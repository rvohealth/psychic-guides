...
sidebar_position: 2
ai_summary: >-
  Psychic and Dream use Encrypt class internally. Cookie encryption config in
  conf/app.ts. Encrypted decorator config in conf/dream.ts. Supports
  current/legacy keys for key rotation.
---
...
:::info
For more information on utilizing cookies, see the [Cookie guides](/docs/controllers/cookies).
:::
...
:::info
For more information on the `@deco.Encrypted` decorator, see the [Encrypted guides](/docs/models/decorators/encrypted)
:::
