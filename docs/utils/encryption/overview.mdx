...
ai_summary: Encrypt class provides symmetric encryption (AES-GCM algorithms: aes-256-gcm, aes-192-gcm, aes-128-gcm). Keys must be base64-encoded with specific bit lengths. Use Encrypt.generateKey() to generate keys. Never hard-code keys - use environment variables or AWS SecretsManager.
---
