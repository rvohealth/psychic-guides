...
Migrations are generated implicitly as by the [model](/docs/cli/generators/model) and [controller](/docs/cli/generators/controller) generators or explicitly using the [migration](/docs/cli/generators/migration) generator.
