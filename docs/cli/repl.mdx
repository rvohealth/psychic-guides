---
sidebar_position: 4
ai_summary: "The REPL (console) enables database inspection through the application. All models are loaded into global namespace, namespaced by folder path. Additional globals can be added via conf/repl.ts."
---
...
The REPL (called `console`) enables you to inspect the database through the lens of your application. The code used to bootstrap your REPL can be found in `conf/repl.ts`:
