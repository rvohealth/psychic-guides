---
sidebar_position: 7
ai_summary: "The diff:openapi command compares the current branch's OpenAPI spec file(s) with the main/master/head branch's OpenAPI spec file(s). Useful for detecting breaking API changes in CI pipelines with the -f (--fail-on-breaking) option."
---
