...
ai_summary: The generate:model command creates a Dream model with migration, spec factory, and serializer. Supports various column types (citext, string, text, date, datetime, integer, decimal, enum, belongs_to), arrays, optional columns, and custom connection names.
---
