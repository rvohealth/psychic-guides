...
ai_summary: "Emit to registered users from anywhere in application (including background jobs). Create Ws instance with allowed routes array. Recommended to set up singleton helper function. Call ws.emit(user, route, data) to send messages."
---
