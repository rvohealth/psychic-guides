...
3. You will need to register this plugin as part of the `initializePsychicApplication.ts` file within your project. It will need to look something like this:
...
} from '@rvohealth/psychic-workers'
