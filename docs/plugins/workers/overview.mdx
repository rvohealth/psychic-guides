...
- To learn how to install Psychic Workers, see the [installation](/docs/plugins/workers/installation) guide
- To learn how to configure Psychic Workers, see the [config](/docs/plugins/workers/config) guide
- To learn how to use background services, see the [services](/docs/plugins/workers/services) guide
- To learn how to use backgrounding functions within models, see the [models](/docs/plugins/workers/models) guide
- To learn how to schedule your services to run at specific times, see the [scheduled](/docs/plugins/workers/scheduled) guide
