...
sidebar_position: 4
title: services
ai_summary: "Classes extending ApplicationBackgroundedService provide background and backgroundWithDelay methods. Background methods by calling this.background('_methodName', args). Keep job arguments to IDs/scalars, look records up with find, and use commit hooks when enqueueing from model lifecycle hooks."
---
