...
sidebar_position: 8
title: priority
ai_summary: "Background job priority customizable via backgroundJobConfig getter. Options: urgent, default, not_urgent, last. Default is 'default'. Use 'last' for check-in jobs to ensure other jobs complete first."
---
