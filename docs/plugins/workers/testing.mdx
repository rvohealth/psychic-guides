...
ai_summary: Backgrounded methods invoked immediately during tests by default. Set testInvocation to 'manual' to push jobs into BullMQ queues. Use WorkerTestUtils.clean() to reset Redis between tests. Use WorkerTestUtils.work() to manually work off jobs.
---
