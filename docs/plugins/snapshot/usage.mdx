...
ai_summary: Install @rvoh/dream-plugin-json-snapshot. Extend model with Snapshotable(ApplicationModel) mixin. Call takeSnapshot() on instance. Use @SnapshotableFollowThrough to include through associations. Use @SnapshotableIgnore to filter out unwanted associations.
---
