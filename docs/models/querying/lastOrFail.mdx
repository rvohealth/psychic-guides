---
ai_summary: "The lastOrFail method returns the last record found in the table. Raises RecordNotFound exception (converted to 404 by Psychic) if no records exist. Can be chained with query building methods like order."
---
