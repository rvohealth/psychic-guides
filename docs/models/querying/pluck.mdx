---
ai_summary: "The pluck method returns raw values for specified attributes. Single attribute returns flattened array. Multiple attributes return array of arrays. Can be chained with query methods. Use pluckEach for large datasets to avoid loading all data into memory."
---
