...
- To learn about counting records, see the [count guide](/docs/models/querying/count).
- To learn about determining if a record exists, see the [exists guide](/docs/models/querying/exists)
- To learn about getting the max value from a given table, see the [max guide](/docs/models/querying/max).
- To learn about getting the min value from a given table, see the [min guide](/docs/models/querying/min).
- To learn about plucking values, see the [pluck](/docs/models/querying/pluck) guides
...
- To learn about left joining associated records, see the [leftJoinPreload guide](/docs/models/querying/leftJoinPreload)
