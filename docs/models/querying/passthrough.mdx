---
ai_summary: Passthrough associations require data to be passed via passthrough method to load. Useful for localization patterns where locale changes per user. Use DreamConst.passthrough in association where clause, then call .passthrough({ key: value }) before loading.
---
# passthrough
