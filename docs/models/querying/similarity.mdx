---
ai_summary: Similarity operations enable fuzzy text searching using PostgreSQL's pg_trgm extension. Three operators: similarity (default 0.3 threshold), wordSimilarity (default 0.5), strictWordSimilarity (default 0.6). Requires pg_trgm extension and optional GIN indexes for performance. Configurable score thresholds.
---
# similarity
