...
ai_summary: "The @deco.Virtual decorator enables setting fields as if they corresponded to database columns, allowing them to be passed to new, create, and update methods. Useful for computed properties, unit conversions, or password hashing."
---
# @deco.Virtual

The `@deco.Virtual` decorator enables setting of fields as if they corresponded to columns in the model's table so they can be passed to [`new`](../creating#new-and-save), [`create`](../creating#create), and [`update`](../updating).
