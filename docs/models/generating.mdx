...
pnpm psy g:model --sti-base-serializer Room \
...
Run `pnpm psy g:model --help` or see [the g:model documentation](/docs/cli/generators/model) for details of the generator API.
