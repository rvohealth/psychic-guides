...
class User extends ApplicationModel {
  ...
  @HasOne(() => UserSettings, { foreignKey: 'userUuid' })
  public userSettings: UserSettings | null
}
```
...
class User extends ApplicationModel {
  ...
  @HasOne(() => Pet, { where: { favorite: true } })
...
class User extends ApplicationModel {
  ...
  @HasOne(() => Pet, { where: { species: DreamConst.required } })
  public favoritePet: Pet | null
}
...
class User extends ApplicationModel {
  ...
  @HasOne(() => LocalizedText, { where: { locale: DreamConst.passthrough } })
...
class User extends ApplicationModel {
  ...
  @HasMany(() => LocalizedText, { whereNot: { deletedAt: null } })
...
```ts
class User extends ApplicationModel {
  HasMany(() => Pet, { primaryKeyOverride: 'uuid' })
  public pets: Pet[]
}
```
