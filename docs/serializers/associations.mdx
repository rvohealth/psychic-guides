...
sidebar_position: 3
title: associations
ai_summary: Serializer association methods include rendersOne (single association) and rendersMany (array of associations). Options include serializerKey (specify which serializer to use), as (rename in output), and flatten (for rendersOne only, flattens nested attributes into parent).
---
