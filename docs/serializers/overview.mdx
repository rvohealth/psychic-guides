...
Serializers are function-based and should use named exports. Avoid class-based serializers and default exports; named serializer functions give OpenAPI stable component names and make runtime registration explicit.
