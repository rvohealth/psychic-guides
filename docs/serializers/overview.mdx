...
- [generating serializer guide](/docs/serializers/generating)
- [serializer attributes guide](/docs/serializers/attributes)
- [serializer associations guide](/docs/serializers/associations)
- [serializer rendering guide](/docs/serializers/render)
