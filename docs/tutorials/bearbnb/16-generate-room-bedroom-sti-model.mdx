...
id: bearbnb-16-generate-room-bedroom-sti-model
---
...
+    .attribute('bedTypes')
diff --git a/api/src/db/migrations/1765414339257-create-room-bedroom.ts b/api/src/db/migrations/1765414339257-create-room-bedroom.ts
new file mode 100644
index 0000000..55d5d4c
--- /dev/null
+++ b/api/src/db/migrations/1765414339257-create-room-bedroom.ts
@@ -0,0 +1,31 @@
