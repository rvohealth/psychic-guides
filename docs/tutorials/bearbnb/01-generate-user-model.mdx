...
+}
diff --git a/api/src/db/migrations/1765049053419-create-user.ts b/api/src/db/migrations/1765049053419-create-user.ts
new file mode 100644
index 0000000..7e99b85
--- /dev/null
+++ b/api/src/db/migrations/1765049053419-create-user.ts
@@ -0,0 +1,24 @@
