...
+}
diff --git a/api/src/db/migrations/1782834969185-create-user.ts b/api/src/db/migrations/1782834969185-create-user.ts
new file mode 100644
index 0000000..3135e21
--- /dev/null
+++ b/api/src/db/migrations/1782834969185-create-user.ts
@@ -0,0 +1,26 @@
