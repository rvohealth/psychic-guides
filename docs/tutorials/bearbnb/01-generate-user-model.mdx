...
+}
diff --git a/api/src/db/migrations/1782925721266-create-user.ts b/api/src/db/migrations/1782925721266-create-user.ts
new file mode 100644
index 0000000..7be5e55
--- /dev/null
+++ b/api/src/db/migrations/1782925721266-create-user.ts
@@ -0,0 +1,32 @@
