...
diff --git a/api/src/db/migrations/1782926483300-create-localized-text.ts b/api/src/db/migrations/1782926483300-create-localized-text.ts
index 1e455cd..a704ce4 100644
--- a/api/src/db/migrations/1782926483300-create-localized-text.ts
+++ b/api/src/db/migrations/1782926483300-create-localized-text.ts
...
@@ -49,4 +35,4 @@ export async function down(db: Kysely<any>): Promise<void> {
...
index c388408..685d465 100644
--- a/api/src/types/db.ts
+++ b/api/src/types/db.ts
@@ -112,6 +112,14 @@ export type Generated<T> =
...
@@ -163,6 +171,18 @@ export interface Hosts {
   userId: string
 }
...
+
 export interface Places {
   createdAt: Timestamp
   deletedAt: Timestamp | null
@@ -199,6 +219,7 @@ export interface DB {
   guests: Guests
...
+  localized_texts: LocalizedTexts
   ...
   rooms: Rooms
   users: Users
@@ -208,6 +229,7 @@ export class DBClass {
   guests: Guests
   host_places: HostPlaces
   hosts: Hosts
+  localized_texts: LocalizedTexts
