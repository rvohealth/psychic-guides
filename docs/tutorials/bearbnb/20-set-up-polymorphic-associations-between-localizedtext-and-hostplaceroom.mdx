...
-    // await localizedText.update(this.extractParams(LocalizedText,
-    //   ['locale', 'title', 'markdown'],
-    // ))
-    // this.noContent()
+    const localizedText = await this.localizedText()
+    await localizedText.update(this.extractParams(LocalizedText, ['locale', 'title', 'markdown']))
+    this.noContent()
   }
