...
+        };
         RoomKitchen: {
             ...
             id: string;
@@ -434,6 +443,15 @@ export interface components {
         RoomKitchenSummary: {
             id: string;
         };
+        RoomLivingRoom: {
