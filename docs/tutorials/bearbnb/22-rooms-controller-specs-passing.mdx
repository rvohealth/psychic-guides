...
id: bearbnb-22-rooms-controller-specs-passing
---
...
// There is also an sql flag. They can be applied simultaneously:
// `NODE_DEBUG=sql,psychic`
```
```
...
+      expectedStatus: StatusCode,
       ...
       return request.patch('/v1/host/places/{placeId}/rooms/{id}', expectedStatus, {
         placeId: place.id,
@@ -121,33 +131,43 @@ describe('V1/Host/Places/RoomsController', () => {
     }
...
+    ) => {
       return request.delete('/v1/host/places/{placeId}/rooms/{id}', expectedStatus, {
         placeId: place.id,
         id: room.id,
@@ -155,7 +175,7 @@ describe('V1/Host/Places/RoomsController', () => {
     }
...
@@ -164,7 +184,7 @@ describe('V1/Host/Places/RoomsController', () => {
...
@@ -13,10 +19,11 @@ export default class V1HostPlacesRoomsController extends V1HostPlacesBaseControl
...
+    this.ok(rooms)
   ...
   @OpenAPI(Room, {
@@ -25,19 +32,67 @@ export default class V1HostPlacesRoomsController extends V1HostPlacesBaseControl
...
+    this.created(room)
   ...
   @OpenAPI(Room, {
@@ -46,9 +101,9 @@ export default class V1HostPlacesRoomsController extends V1HostPlacesBaseControl
...
+    this.noContent()
   ...
   @OpenAPI({
@@ -57,14 +112,15 @@ export default class V1HostPlacesRoomsController extends V1HostPlacesBaseControl
...
index c146340..a26460e 100644
--- a/api/src/types/dream.ts
+++ b/api/src/types/dream.ts
@@ -397,6 +397,15 @@ export const schema = {
