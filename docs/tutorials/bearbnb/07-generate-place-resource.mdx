...
diff --git a/api/src/db/migrations/1782925986336-create-place.ts b/api/src/db/migrations/1782925986336-create-place.ts
new file mode 100644
index 0000000..6c0a5c0
--- /dev/null
+++ b/api/src/db/migrations/1782925986336-create-place.ts
@@ -0,0 +1,48 @@
