...
+  })
+  public async create() {
+    // let place = await this.currentHost.createAssociation('places', this.extractParams(Place,
+    //   ['name', 'style', 'sleeps'],
+    // ))
...
+  public async update() {
+    // const place = await this.place()
+    // await place.update(this.extractParams(Place,
+    //   ['name', 'style', 'sleeps'],
+    // ))
+    // this.noContent()
+  }
...
diff --git a/api/src/db/migrations/1773151915966-create-place.ts b/api/src/db/migrations/1773151915966-create-place.ts
new file mode 100644
index 0000000..c18822a
--- /dev/null
+++ b/api/src/db/migrations/1773151915966-create-place.ts
@@ -0,0 +1,42 @@
