...
diff --git a/api/src/db/migrations/1765411129394-create-place.ts b/api/src/db/migrations/1765411129394-create-place.ts
new file mode 100644
index 0000000..c18822a
--- /dev/null
+++ b/api/src/db/migrations/1765411129394-create-place.ts
@@ -0,0 +1,42 @@
