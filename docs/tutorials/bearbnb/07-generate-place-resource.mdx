...
diff --git a/api/src/db/migrations/1782835396157-create-place.ts b/api/src/db/migrations/1782835396157-create-place.ts
new file mode 100644
index 0000000..4270fd8
--- /dev/null
+++ b/api/src/db/migrations/1782835396157-create-place.ts
@@ -0,0 +1,42 @@
