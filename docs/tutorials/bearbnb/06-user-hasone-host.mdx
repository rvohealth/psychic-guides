...
diff --git a/api/src/db/migrations/1782925912760-create-host.ts b/api/src/db/migrations/1782925912760-create-host.ts
index f1445a9..4302ccf 100644
--- a/api/src/db/migrations/1782925912760-create-host.ts
+++ b/api/src/db/migrations/1782925912760-create-host.ts
