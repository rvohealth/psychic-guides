...
diff --git a/api/src/db/migrations/1779136689943-create-room.ts b/api/src/db/migrations/1779136689943-create-room.ts
new file mode 100644
index 0000000..100a7ce
--- /dev/null
+++ b/api/src/db/migrations/1779136689943-create-room.ts
@@ -0,0 +1,51 @@
...
@@ -218,6 +413,15 @@ export interface components {
             id: string;
             name: string;
         };
+        Room: {
