...
diff --git a/api/src/db/migrations/1765052082940-create-room.ts b/api/src/db/migrations/1765052082940-create-room.ts
new file mode 100644
index 0000000..ab4029e
--- /dev/null
+++ b/api/src/db/migrations/1765052082940-create-room.ts
@@ -0,0 +1,51 @@
