...
diff --git a/api/src/db/migrations/1782835926764-create-room.ts b/api/src/db/migrations/1782835926764-create-room.ts
new file mode 100644
index 0000000..100a7ce
--- /dev/null
+++ b/api/src/db/migrations/1782835926764-create-room.ts
@@ -0,0 +1,51 @@
...
index 7271711..0da5bf1 100644
--- a/api/src/types/db.ts
+++ b/api/src/types/db.ts
@@ -86,6 +86,17 @@ export const PlaceStylesEnumValues = [
   'treehouse',
 ] as const
...
@@ -123,6 +134,16 @@ export interface Places {
   updatedAt: Timestamp
 }
...
+
 export interface Users {
   createdAt: Timestamp
   deletedAt: Timestamp | null
@@ -137,6 +158,7 @@ export interface DB {
...
@@ -145,5 +167,6 @@ export class DBClass {
   host_places: HostPlaces
   hosts: Hosts
   places: Places
+  rooms: Rooms
...
+} from './db.js'
 ...
 export const schema = {
   guests: {
@@ -411,6 +416,99 @@ export const schema = {
       },
     },
   },
+  rooms: {
...
+  },
   users: {
     serializerKeys: [],
     scopes: {
@@ -514,6 +612,7 @@ export const connectionTypeConfig = {
       Host: 'hosts',
...
@@ -213,6 +403,15 @@ export interface components {
             id: string;
             name: string;
         };
+        Room: {
