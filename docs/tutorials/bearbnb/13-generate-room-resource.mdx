...
diff --git a/api/src/db/migrations/1773152983694-create-room.ts b/api/src/db/migrations/1773152983694-create-room.ts
new file mode 100644
index 0000000..1de9d4c
--- /dev/null
+++ b/api/src/db/migrations/1773152983694-create-room.ts
@@ -0,0 +1,51 @@
...
@@ -127,6 +142,16 @@ export interface Places {
   updatedAt: Timestamp
 }
...
@@ -148,5 +174,6 @@ export class DBClass {
   host_places: HostPlaces
   hosts: Hosts
   places: Places
+  rooms: Rooms
...
+} from './db.js'
 ...
 export const schema = {
   guests: {
@@ -393,6 +398,99 @@ export const schema = {
       },
     },
   },
+  rooms: {
...
+  },
   users: {
     serializerKeys: [],
     scopes: {
@@ -486,6 +584,7 @@ export const connectionTypeConfig = {
       Host: 'hosts',
