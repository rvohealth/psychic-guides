...
+    .attribute('bedTypes')
diff --git a/api/src/db/migrations/1782836036208-create-room-bedroom.ts b/api/src/db/migrations/1782836036208-create-room-bedroom.ts
new file mode 100644
index 0000000..55d5d4c
--- /dev/null
+++ b/api/src/db/migrations/1782836036208-create-room-bedroom.ts
@@ -0,0 +1,31 @@
...
@@ -78,6 +86,18 @@ export const BathOrShowerStylesEnumValues = [
   'shower',
 ] as const
...
@@ -146,6 +166,7 @@ export interface Places {
...
@@ -426,6 +428,7 @@ export const schema = {
     },
     nonJsonColumnNames: [
       'bathOrShowerStyle',
+      'bedTypes',
       ...
       'deletedAt',
       'id',
@@ -444,6 +447,15 @@ export const schema = {
         allowNull: true,
         isArray: false,
       },
+      bedTypes: {
...
+      },
       createdAt: {
         ...
         enumType: null,
@@ -626,6 +638,7 @@ export const connectionTypeConfig = {
       Place: 'places',
       Room: 'rooms',
       'Room/Bathroom': 'rooms',
+      'Room/Bedroom': 'rooms',
