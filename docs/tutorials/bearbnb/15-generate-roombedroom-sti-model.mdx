...
+    .attribute('bedTypes')
diff --git a/api/src/db/migrations/1779136808507-create-room-bedroom.ts b/api/src/db/migrations/1779136808507-create-room-bedroom.ts
new file mode 100644
index 0000000..55d5d4c
--- /dev/null
+++ b/api/src/db/migrations/1779136808507-create-room-bedroom.ts
@@ -0,0 +1,31 @@
...
@@ -159,6 +184,7 @@ export interface Places {
...
+                        "application/json": components["schemas"]["RoomBathroom"] | components["schemas"]["RoomBedroom"];
                 ...
                 400: components["responses"]["BadRequest"];
@@ -424,6 +424,16 @@ export interface components {
         RoomBathroomSummary: {
             id: string;
         };
+        RoomBedroom: {
