...
index 73f17b4..b3e680f 100644
--- a/api/src/types/dream.ts
+++ b/api/src/types/dream.ts
@@ -277,6 +277,15 @@ export const schema = {
     },
     virtualColumns: [],
     associations: {
...
+      },
       hostPlaces: {
         type: 'HasMany',
         foreignKey: 'hostId',
@@ -510,6 +519,15 @@ export const schema = {
     },
     virtualColumns: [],
     associations: {
+      currentLocalizedText: {
...
+      },
       hostPlaces: {
         type: 'HasMany',
         foreignKey: 'placeId',
@@ -660,6 +678,15 @@ export const schema = {
     },
     virtualColumns: [],
     associations: {
+      currentLocalizedText: {
...
+      },
       localizedTexts: {
         type: 'HasMany',
         foreignKey: 'localizableId',
@@ -765,7 +792,7 @@ export const schema = {
 } as const
