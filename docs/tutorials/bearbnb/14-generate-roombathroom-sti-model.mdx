...
diff --git a/api/src/db/migrations/1782836000936-create-room-bathroom.ts b/api/src/db/migrations/1782836000936-create-room-bathroom.ts
new file mode 100644
index 0000000..3c845b2
--- /dev/null
+++ b/api/src/db/migrations/1782836000936-create-room-bathroom.ts
@@ -0,0 +1,37 @@
...
+                        "application/json": components["schemas"]["RoomBathroom"];
                 ...
                 400: components["responses"]["BadRequest"];
@@ -403,13 +403,15 @@ export interface components {
             id: string;
             name: string;
         };
-        Room: {
