...
+}
diff --git a/api/src/db/migrations/1782926044185-create-host-place.ts b/api/src/db/migrations/1782926044185-create-host-place.ts
new file mode 100644
index 0000000..aaee4d0
--- /dev/null
+++ b/api/src/db/migrations/1782926044185-create-host-place.ts
@@ -0,0 +1,41 @@
