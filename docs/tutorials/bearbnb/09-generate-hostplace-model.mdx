...
+}
diff --git a/api/src/db/migrations/1765411215763-create-host-place.ts b/api/src/db/migrations/1765411215763-create-host-place.ts
new file mode 100644
index 0000000..833a587
--- /dev/null
+++ b/api/src/db/migrations/1765411215763-create-host-place.ts
@@ -0,0 +1,37 @@
