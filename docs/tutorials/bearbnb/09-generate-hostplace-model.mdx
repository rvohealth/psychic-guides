...
id: bearbnb-09-generate-hostplace-model
---
...
+}
diff --git a/api/src/db/migrations/1779136456787-create-host-place.ts b/api/src/db/migrations/1779136456787-create-host-place.ts
new file mode 100644
index 0000000..51e2e52
--- /dev/null
+++ b/api/src/db/migrations/1779136456787-create-host-place.ts
@@ -0,0 +1,37 @@
