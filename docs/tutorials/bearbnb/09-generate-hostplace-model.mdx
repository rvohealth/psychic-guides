...
+}
diff --git a/api/src/db/migrations/1765051358136-create-host-place.ts b/api/src/db/migrations/1765051358136-create-host-place.ts
new file mode 100644
index 0000000..7d47d55
--- /dev/null
+++ b/api/src/db/migrations/1765051358136-create-host-place.ts
@@ -0,0 +1,37 @@
