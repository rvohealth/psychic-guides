...
id: bearbnb-18-generate-room-kitchen-sti-model
---
...
diff --git a/api/src/db/migrations/1765414422577-create-room-kitchen.ts b/api/src/db/migrations/1765414422577-create-room-kitchen.ts
new file mode 100644
index 0000000..d798b22
--- /dev/null
+++ b/api/src/db/migrations/1765414422577-create-room-kitchen.ts
@@ -0,0 +1,29 @@
