...
index cd08bd3..605ac00 100644
--- a/api/src/types/dream.ts
+++ b/api/src/types/dream.ts
@@ -123,6 +123,98 @@ export const schema = {
       },
     },
   },
+  host_places: {
...
+  },
   hosts: {
     ...
     scopes: {
@@ -170,6 +262,24 @@ export const schema = {
     },
     virtualColumns: [],
     associations: {
+      hostPlaces: {
...
+      },
       user: {
         type: 'BelongsTo',
         foreignKey: 'userId',
@@ -262,7 +372,26 @@ export const schema = {
       },
     },
     virtualColumns: [],
-    associations: {},
...
+    },
   ...
   users: {
     serializerKeys: [],
@@ -355,6 +484,7 @@ export const connectionTypeConfig = {
     models: {
       Guest: 'guests',
       Host: 'hosts',
