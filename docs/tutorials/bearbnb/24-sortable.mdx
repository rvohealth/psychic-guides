...
diff --git a/api/src/db/migrations/1782926679181-add-deferrable-unique-constraint-to-rooms.ts b/api/src/db/migrations/1782926679181-add-deferrable-unique-constraint-to-rooms.ts
new file mode 100644
index 0000000..556bb0a
--- /dev/null
+++ b/api/src/db/migrations/1782926679181-add-deferrable-unique-constraint-to-rooms.ts
@@ -0,0 +1,19 @@
