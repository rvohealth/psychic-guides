...
diff --git a/api/src/db/migrations/1773157634327-add-deferrable-unique-constraint-to-rooms.ts b/api/src/db/migrations/1773157634327-add-deferrable-unique-constraint-to-rooms.ts
new file mode 100644
index 0000000..acf0882
--- /dev/null
+++ b/api/src/db/migrations/1773157634327-add-deferrable-unique-constraint-to-rooms.ts
@@ -0,0 +1,19 @@
