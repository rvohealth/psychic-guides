...
id: bearbnb-24-set-up-polymorphic-associations-between-localizedtext-and-host-place-room
---
...
diff --git a/api/src/db/migrations/1765416239882-create-localized-text.ts b/api/src/db/migrations/1765416239882-create-localized-text.ts
index 58549f0..5819bd4 100644
--- a/api/src/db/migrations/1765416239882-create-localized-text.ts
+++ b/api/src/db/migrations/1765416239882-create-localized-text.ts
