...
diff --git a/api/src/db/migrations/1782836077272-create-room-kitchen.ts b/api/src/db/migrations/1782836077272-create-room-kitchen.ts
new file mode 100644
index 0000000..d798b22
--- /dev/null
+++ b/api/src/db/migrations/1782836077272-create-room-kitchen.ts
@@ -0,0 +1,29 @@
...
@@ -165,6 +174,7 @@ export interface Places {
 }
