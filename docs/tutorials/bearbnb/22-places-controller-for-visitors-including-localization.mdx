...
be Spanish, make sure you have added `es` to the locales map
...
the ESLint server in your editor, and if that does not work,
...
pnpm uspec spec/unit/controllers/Visitor/V1/PlacesController.spec.ts
// If you get 400, use NODE_DEBUG=psychic to see OpenAPI validation errors
NODE_DEBUG=psychic pnpm uspec spec/unit/controllers/Visitor/V1/PlacesController.spec.ts
pnpm uspec
```
...
index b38ff11..aaae03d 100644
--- a/api/src/app/models/Room/Bathroom.ts
+++ b/api/src/app/models/Room/Bathroom.ts
@@ -8,6 +8,7 @@ export default class Bathroom extends Room {
     return {
...
index e8fc0b2..fa7c36a 100644
--- a/api/src/app/models/Room/Bedroom.ts
+++ b/api/src/app/models/Room/Bedroom.ts
@@ -8,6 +8,7 @@ export default class Bedroom extends Room {
     return {
