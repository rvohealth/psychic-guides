---
title: Places controller for Visitors, including localization
id: bearbnb-22-places-controller-for-visitors-including-localization
---

# Places controller for Visitors, including localization
...
The V1/Visitor namespace uses MaybeAuthedController as its base,
so the Places index and show endpoints work whether or not the
caller is authenticated. The spec demonstrates both contexts.

```console
pnpm psy g:controller --help
pnpm psy g:controller V1/Visitor/Places index show
...
pnpm uspec spec/unit/controllers/V1/Visitor/PlacesController.spec.ts
// If you get 400, use NODE_DEBUG=psychic to see OpenAPI validation errors
NODE_DEBUG=psychic pnpm uspec spec/unit/controllers/V1/Visitor/PlacesController.spec.ts
pnpm uspec
```

Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>
Claude-Session: https://claude.ai/code/session_015KTzZW1VMPnC3xMwePsEPH
``````

## Changes

``````
diff --git a/api/spec/unit/controllers/V1/Visitor/PlacesController.spec.ts b/api/spec/unit/controllers/V1/Visitor/PlacesController.spec.ts
new file mode 100644
index 0000000..381b455
--- /dev/null
+++ b/api/spec/unit/controllers/V1/Visitor/PlacesController.spec.ts
@@ -0,0 +1,223 @@
...
+
+describe('V1/Visitor/PlacesController', () => {
...
diff --git a/api/src/app/controllers/V1/Visitor/BaseController.ts b/api/src/app/controllers/V1/Visitor/BaseController.ts
new file mode 100644
index 0000000..9a08056
--- /dev/null
+++ b/api/src/app/controllers/V1/Visitor/BaseController.ts
@@ -0,0 +1,3 @@
+import MaybeAuthedController from '../../MaybeAuthedController.js'
+
+export default class V1VisitorBaseController extends MaybeAuthedController {}
diff --git a/api/src/app/controllers/V1/Visitor/PlacesController.ts b/api/src/app/controllers/V1/Visitor/PlacesController.ts
new file mode 100644
index 0000000..d9cee81
--- /dev/null
+++ b/api/src/app/controllers/V1/Visitor/PlacesController.ts
@@ -0,0 +1,37 @@
+import { OpenAPI } from '@rvoh/psychic'
+import Place from '@models/Place.js'
+import V1VisitorBaseController from './BaseController.js'
+
+const openApiTags = ['visitor-places']
+
+export default class V1VisitorPlacesController extends V1VisitorBaseController {
+  @OpenAPI(Place, {
+    status: 200,
+    tags: openApiTags,
...
index ff6749b..5f98fa3 100644
--- a/api/src/conf/routes.ts
+++ b/api/src/conf/routes.ts
@@ -4,6 +4,10 @@ import { PsychicRouter } from '@rvoh/psychic'
