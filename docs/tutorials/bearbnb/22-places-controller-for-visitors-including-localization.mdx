...
The Visitor namespace uses MaybeAuthedController as its base,
...
pnpm psy g:controller Visitor/Places index show
...
pnpm uspec spec/unit/controllers/Visitor/PlacesController.spec.ts
// If you get 400, use NODE_DEBUG=psychic to see OpenAPI validation errors
NODE_DEBUG=psychic pnpm uspec spec/unit/controllers/Visitor/PlacesController.spec.ts
pnpm uspec
```
...
``````
diff --git a/api/spec/unit/controllers/Visitor/PlacesController.spec.ts b/api/spec/unit/controllers/Visitor/PlacesController.spec.ts
new file mode 100644
index 0000000..e02855d
--- /dev/null
+++ b/api/spec/unit/controllers/Visitor/PlacesController.spec.ts
@@ -0,0 +1,223 @@
...
diff --git a/api/src/app/controllers/Visitor/PlacesController.ts b/api/src/app/controllers/Visitor/PlacesController.ts
new file mode 100644
index 0000000..2a7469c
--- /dev/null
+++ b/api/src/app/controllers/Visitor/PlacesController.ts
@@ -0,0 +1,37 @@
+import Place from '@models/Place.js'
