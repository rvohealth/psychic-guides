...
id: bearbnb-20-rename-generated-roomkitchen-to-kitchen
---
...
index c66af38..34aae49 100644
--- a/api/src/types/db.ts
+++ b/api/src/types/db.ts
@@ -63,6 +63,15 @@ import { type CalendarDate, type DateTime } from '@rvoh/dream'
  */
...
@@ -176,6 +185,7 @@ export interface Places {
 }
...
index 7ff53e5..f271b70 100644
--- a/api/src/types/dream.ts
+++ b/api/src/types/dream.ts
@@ -58,10 +58,12 @@ us humans, he says:
...
@@ -404,6 +406,7 @@ export const schema = {
       named: [],
     },
     nonJsonColumnNames: [
+      'appliances',
       ...
       'bedTypes',
       'createdAt',
@@ -415,6 +418,15 @@ export const schema = {
       'updatedAt',
     ],
     columns: {
+      appliances: {
...
@@ -591,6 +603,7 @@ export const connectionTypeConfig = {
       Room: 'rooms',
       'Room/Bathroom': 'rooms',
       'Room/Bedroom': 'rooms',
+      'Room/Kitchen': 'rooms',
