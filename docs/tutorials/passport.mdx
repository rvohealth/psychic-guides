...
title: passport
ai_summary: >-
  Tutorial for integrating Passport.js with Psychic using local strategy. Covers
  middleware setup, authentication endpoints, spec coverage. Uses Koa middleware
  for passport integration with koa-passport and koa-session. Provides example
  with valid/invalid credential handling.
---
