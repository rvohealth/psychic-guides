...
This approach bypasses the controller layer, which we don't recommend since it provides such helpful utilities, but can be useful sometimes, say, when integrating with Express middleware.
