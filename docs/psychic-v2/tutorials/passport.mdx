...
ai_summary: "Tutorial for integrating Passport.js with Psychic using local strategy. Covers middleware setup, authentication endpoints, spec coverage. Uses Express middleware for passport integration. Provides example with valid/invalid credential handling."
---
...
<PackageManagerTabs
  code={`{{PM}} add passport passport-local @types/passport @types/passport-local express-session @types/express-session`}
/>
