---
sidebar_position: 2
ai_summary: "Controller parameter handling with castParam for individual parameter validation and extractParams / extractImplicitParams for type-checked, runtime-intersected extraction of model-safe parameters. Supports type casting, OpenAPI shape validation, and explicit or implicit allowlists."
---
