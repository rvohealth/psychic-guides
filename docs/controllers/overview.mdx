...
* To learn about handling exceptions, see our [exception handling](/docs/controllers/responses) guide
* To learn about openapi integration, see our [openapi](/docs/controllers/responses) guide
:::
