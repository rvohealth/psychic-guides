...
ai_summary: "Psychic controllers extend PsychicController and handle HTTP requests. They work with routes, provide status code response methods (ok, created, noContent, etc.), support OpenAPI decorator for automatic spec generation, and include helpers for params, cookies, serialization, and exception handling."
---
