---
sidebar_position: 4
ai_summary: "Psychic automatically handles certain errors with intuitive response codes. castParam raises 400 for invalid params. extractParams raises 400 for invalid model attributes. Failable lookups (findOrFail, firstOrFail) raise 404 for not found. Validation errors raise 422."
---
